...
font-family: arial; color:#333; height:100%; margin:0; padding:0em; font-size:80% 
</xsl:template>
...
background-color:#e9e9e9;  width:100%; text-shadow:1px 1px 1px #333; color:#000; margin-top:1em;  font-weight:700; line-height:2em; font-size:120%;
</xsl:template>
